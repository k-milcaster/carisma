...
//        kunjungan.setTransaksijualobatIdTransaksijual(" ");
//        kunjungan.setPasienKamarIdPeminjaman(" ");
    ...
    public boolean cekIdPasien(String idPasien) throws RemoteException {
        ...
        //System.out.println(""+pasienService.getPasien(idPasien));        
        //String idPasienK = pasien.getIdPasien();
