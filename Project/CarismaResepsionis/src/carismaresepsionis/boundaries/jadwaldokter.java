...
public class jadwaldokter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gigi dan Mulut", "Umum" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Dr. Elly", "Dr. Hendrik" }));
